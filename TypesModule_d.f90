...
! Áª?‰∏?ÂÆ?‰π?64‰ΩçÊ?¥Ê?∞Â??ÂÆ?Ê?∞Â∏∏È?è
! 8Â≠?Ë??Ê?¥Ê?∞:real64ÂèØÁ≤æÁ°ÆÂ≠?Â?® 15-17 ‰ΩçÂçÅËø?Â?∂Ê??Ê??Ê?∞Â≠?,Ê??Ê?∞Ë??Â?¥Ê?Ø 10‚Åª¬≥‚Å∞‚Å∏~10¬≥‚Å∞‚Å∏.Â?†Ê≠§ÂÆ?Â?®ÂèØÂ≠?Â
!?®4.06575815E-20
  INTEGER, PARAMETER :: int64=8
! 8Â≠?Ë??ÂÆ?Ê?∞Ôº?Âè?Á≤æÂ∫¶Ôº?
  INTEGER, PARAMETER :: real64=8
  CHARACTER(len=256), ALLOCATABLE :: lines_defor(:)
!!!!!!!!!!!!!!!!Buflow
!    real(kind=8), allocatable :: first5_refs(:,:)  ! ÂΩ¢Á?∂(5,3)!!!!!!!!!!!!
...
& :)
  ...
  REAL(kind=8), ALLOCATABLE :: point_updated_rhs(:, :)
  REAL(kind=8), ALLOCATABLE :: wing(:, :), inoutput(:, :)
!!!!!!!!!drag
! È?ªÂ??‰º¥È?èÔº?Â≠?Ê?æÂΩ?Â?çÈ?ªÂ?? JÔº?Ê†?È?èÔº?Ôº?‰æ? Tapenade/È©±Â?®‰ΩøÁ?®
